...
def lex_net(word, length, args, vocab_size, num_labels, for_infer = True, target=None):
    ...
    def _bigru_layer(input_feature):
        ...
        gru,_ = fluid.layers.rnn(cell=gru_cell, inputs=input_feature, sequence_length=length)
        ...
        #             regularization_coeff=1e-4)),
        #     num_flatten_dims=2)
        gru_r,_ = fluid.layers.rnn(cell=gru_cell, inputs=input_feature, sequence_length=length,is_reverse=True)
