...
def ctc_train_net(args, data_shape, num_classes):
    ...
    casted_num_classes = fluid.layers.cast(x=num_classes, dtype='int32')
    ...
    cost = fluid.layers.warpctc(
        input=casted_fc_out, label=casted_label, blank=casted_num_classes, norm_by_times=True,input_length=casted_seq_length,label_length=casted_label_length)
    # print("cost",cost)
    # 384 1
